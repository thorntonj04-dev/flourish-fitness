...
# Flourish Fitness - Luxury Dark Mode Redesign Script
# Run this from your flourish-fitness project root directory

set -e  # Exit on any error

echo "🎨 Starting Flourish Fitness Luxury Redesign..."
echo ""

# Check if we're in the right directory
if [ ! -f "package.json" ]; then
    echo "❌ Error: package.json not found. Please run this script from your flourish-fitness project root."
    exit 1
fi
...
cp tailwind.config.js .redesign-backup/ 2>/dev/null || echo "No tailwind.config.js to backup"
cp src/App.jsx .redesign-backup/
cp src/index.css .redesign-backup/

# 1. Update tailwind.config.js
echo "⚙️  Updating Tailwind config with luxury color palette..."
...
# 2. Update index.css with fonts and dark mode enforcement
...
::-webkit-scrollbar-thumb {
  @apply bg-sage-dark rounded-full;
}
...
# 3. Update App.jsx with new color scheme
echo "✨ Updating App.jsx with luxury theme..."
...
echo ""
echo "📋 Next Steps:"
echo "   1. Copy your logo files to public/logos/"
echo "      - fflogo.png"
echo "      - logosmall.png"
echo "      - logosmall2.png"
echo ""
...
echo ""
echo "   3. Update individual components with new colors:"
echo "      - Replace 'emerald' → 'gold' for primary actions"
echo "      - Replace 'bg-white' → 'bg-charcoal-light'"
echo "      - Replace 'bg-gray-50' → 'bg-charcoal'"
echo "      - Replace 'text-gray-900' → 'text-cream'"
echo ""
echo "💾 Backups saved to: .redesign-backup/"
echo ""
echo "🎨 Luxury redesign foundation complete!"
