      ...
      <div className="bg-white dark:bg-[#1E3328] rounded-3xl shadow-2xl max-w-4xl w-full max-h-[90vh] overflow-hidden">
        ...
        <div className="overflow-y-auto max-h-[calc(90vh-120px)] p-8">
          ...
          <div className="prose prose-lg max-w-none dark:prose-invert mb-8">
            <p className="text-gray-700 dark:text-[#d8e7de]/80 leading-relaxed">
          ...
          <div className="mb-8">
            <h3 className="text-2xl font-bold text-gray-900 dark:text-[#d8e7de] mb-6 flex items-center gap-2">
            ...
            <div className="bg-gradient-to-r from-emerald-50 to-teal-50 dark:from-emerald-900/20 dark:to-teal-900/20 rounded-2xl p-6 border-2 border-emerald-200 dark:border-emerald-800">
              <h4 className="font-bold text-gray-900 dark:text-[#d8e7de] mb-4">Plus Everything You Need:</h4>
              <div className="grid md:grid-cols-2 gap-3 text-sm">
                <div className="flex items-start gap-2">
                  <span className="text-emerald-600 dark:text-[#FFD700] mt-0.5">✓</span>
                  <span className="text-gray-700 dark:text-[#d8e7de]/80">Workout templates you can reuse</span>
                </div>
                <div className="flex items-start gap-2">
                  <span className="text-emerald-600 dark:text-[#FFD700] mt-0.5">✓</span>
                  <span className="text-gray-700 dark:text-[#d8e7de]/80">Client workout history & analytics</span>
                </div>
                <div className="flex items-start gap-2">
                  <span className="text-emerald-600 dark:text-[#FFD700] mt-0.5">✓</span>
                  <span className="text-gray-700 dark:text-[#d8e7de]/80">Mobile-friendly responsive design</span>
                </div>
                <div className="flex items-start gap-2">
                  <span className="text-emerald-600 dark:text-[#FFD700] mt-0.5">✓</span>
                  <span className="text-gray-700 dark:text-[#d8e7de]/80">Secure role-based access</span>
                </div>
                <div className="flex items-start gap-2">
                  <span className="text-emerald-600 dark:text-[#FFD700] mt-0.5">✓</span>
                  <span className="text-gray-700 dark:text-[#d8e7de]/80">Difficulty rating after each workout</span>
                </div>
                <div className="flex items-start gap-2">
                  <span className="text-emerald-600 dark:text-[#FFD700] mt-0.5">✓</span>
                  <span className="text-gray-700 dark:text-[#d8e7de]/80">Professional branded experience</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="bg-gradient-to-r from-purple-50 to-pink-50 dark:from-purple-900/20 dark:to-pink-900/20 rounded-2xl p-6 border-2 border-purple-200 dark:border-purple-800 mb-8">
            <h3 className="text-xl font-bold text-gray-900 dark:text-[#d8e7de] mb-3 flex items-center gap-2">
            ...
            <p className="text-gray-700 dark:text-[#d8e7de]/80 leading-relaxed mt-3">
...
function FeatureCard({ icon, title, description, gradient }) {
  return (
    <div className="bg-white dark:bg-[#1E3328] rounded-xl p-5 border-2 border-gray-200 dark:border-[#C6A45F]/25 hover:border-emerald-300 dark:hover:border-emerald-600 transition-all hover:shadow-lg">
      {/* Icon with gradient background */}
      <div className={`w-12 h-12 rounded-lg bg-gradient-to-r ${gradient} flex items-center justify-center text-white mb-3`}>
        {icon}
      </div>
      {/* Feature title */}
      <h4 className="font-bold text-gray-900 dark:text-[#d8e7de] mb-2">{title}</h4>
      {/* Feature description */}
      <p className="text-sm text-gray-600 dark:text-[#d8e7de]/60 leading-relaxed">{description}</p>
    </div>
  );
}
...
function RoadmapItem({ icon, title, description, priority, priorityColor }) {
  return (
    <div className="bg-white dark:bg-[#1E3328] rounded-xl p-5 border-2 border-gray-200 dark:border-[#C6A45F]/25">
      <div className="flex items-start gap-4">
        {/* Icon */}
        <div className="flex-shrink-0 w-10 h-10 rounded-lg bg-gray-100 dark:bg-[#1E3328]/80 flex items-center justify-center text-gray-600 dark:text-[#d8e7de]/80">
          {icon}
        </div>
        {/* Content */}
        <div className="flex-1">
          <div className="flex items-center gap-3 mb-2">
            {/* Title */}
            <h4 className="font-bold text-gray-900 dark:text-[#d8e7de]">{title}</h4>
            {/* Priority Badge */}
