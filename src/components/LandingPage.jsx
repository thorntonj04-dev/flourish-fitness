    ...
    <div className="min-h-screen bg-[#0a0a0a] text-white antialiased">
      ...
      >
        <div
          ...
          style={{
            backgroundImage: "url('/images/IMG_0254.jpeg')",
      ...
      >
        <div className="grid md:grid-cols-2">
          <div
            ...
            style={{
              backgroundImage: "url('/images/IMG_8898.jpeg')",
      ...
      >
        <div className="grid md:grid-cols-2">
          ...
          <div
            ...
            style={{ backgroundImage: "url('/images/IMG_8398.jpeg')", filter: 'brightness(0.75) contrast(1.05) saturate(1.05)' }}
          />
        </div>
      </motion.section>
      ...
      >
        <div
          className="absolute inset-0 bg-cover bg-center"
          style={{
            backgroundImage: "url('/images/IMG_2897.jpeg')",
